...
public class BlockEntityHandler {
    ...
    public static final RegistryObject<BlockEntityType<GrimSpireDoorBlockEntity>> GRIMSPIRE_DOOR = BLOCK_ENTITIES.register("grimspire_door", () -> BlockEntityType.Builder.of(GrimSpireDoorBlockEntity::new, BlockHandler.GRIMSPIRE_DOOR_ENTITY.get()).build(null));

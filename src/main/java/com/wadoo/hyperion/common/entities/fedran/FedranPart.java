...
public class FedranPart extends PartEntity<FedranEntity> {
    public final FedranEntity parent;
    public final String name;
    public final EntityDimensions dimensions;
    public FedranPart(FedranEntity parent, String name, float width, float height) {
        super(parent);
        this.parent = parent;
        this.name = name;

...
public class AgolConnectorModel extends DefaultedEntityGeoModel<AgolConnectorEntity> {
    public AgolConnectorModel() {
        super(new ResourceLocation(Hyperion.MODID, "agol/agol_connector"));
    }

    @Override
    public RenderType getRenderType(AgolConnectorEntity animatable, ResourceLocation texture) {
        return RenderType.entityTranslucent(getTextureResource(animatable));
    }

    @Override
    public void setCustomAnimations(AgolConnectorEntity animatable, long instanceId, AnimationState<AgolConnectorEntity> animationState) {

...
public class AgolModuleModel extends DefaultedEntityGeoModel<AgolModuleEntity> {
    public AgolModuleModel() {
        super(new ResourceLocation(Hyperion.MODID, "agol/agol_base"));
    }


    @Override
    public RenderType getRenderType(AgolModuleEntity animatable, ResourceLocation texture) {
        return RenderType.entityTranslucent(getTextureResource(animatable));
    }

    @Override
    public void setCustomAnimations(AgolModuleEntity animatable, long instanceId, AnimationState<AgolModuleEntity> animationState) {

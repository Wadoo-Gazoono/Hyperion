...
public class CrucibleEyesLayer<T extends CrucibleEntity> extends GeoRenderLayer<CrucibleEntity> {
    private ResourceLocation texture = new ResourceLocation(Hyperion.MODID, "textures/entity/crucible_eyes.png");
    public CrucibleEyesLayer(GeoRenderer<CrucibleEntity> entityRenderer) {

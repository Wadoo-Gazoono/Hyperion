...
public class GruskEyesLayer<T extends CrucibleEntity> extends GeoRenderLayer<CrucibleEntity> {
    private ResourceLocation texture = new ResourceLocation(Hyperion.MODID, "textures/entity/grusk_eyes.png");
    public GruskEyesLayer(GeoRenderer<CrucibleEntity> entityRenderer) {

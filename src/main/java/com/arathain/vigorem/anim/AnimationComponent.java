...
//import com.arathain.vigorem.api.anim.ExtendableAnimation;
...
//            currentCycle.tick(this.obj, Minecraft.getInstance());
...
//        if(tag.contains("namespace") && Animations.getAnimation(new ResourceLocation(tag.getString("namespace"), tag.getString("path"))) != null) {
//            this.current = Animations.getAnimation(new ResourceLocation(tag.getString("namespace"), tag.getString("path")));
//            assert this.current != null;
//            this.current.readNbt(tag);
//        } else {
//            this.current = null;
//        }
//        if(tag.contains("Quu") && Animations.getAnimation(new ResourceLocation(tag.getString("Quu"))) != null) {
//            this.queued = Animations.getAnimation(new ResourceLocation(tag.getString("Quu")));
//        } else {
//            this.queued = null;
//        }
//    }
